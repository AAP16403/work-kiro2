...
class EnemyTuningLogic:
    ...
    def __init__(self) -> None:
        self.difficulty_modifiers: dict[str, dict[str, float]] = {
            "easy": {"spawn": 0.85, "hp": 0.88, "speed": 0.92, "powerup": 1.15, "boss_hp": 0.92},
            "normal": {"spawn": 1.0, "hp": 1.0, "speed": 1.0, "powerup": 1.0, "boss_hp": 1.0},
            "hard": {"spawn": 1.12, "hp": 1.16, "speed": 1.08, "powerup": 0.9, "boss_hp": 1.08},
        }
